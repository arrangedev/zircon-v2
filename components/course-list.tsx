              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-lg font-bold bg-[#FF25CF] text-white"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
...
const cards = [
  {
    ...
    content: () => {
      return (
        <p>
          Start your Solana developer journey off with a bang by shipping a
          "BuyMeACoffee" app with Web3.js. You'll learn the basics of Solana,
          how to use it's libraries in a practical TypeScript context, and
          implement core features into a React frontend.
        </p>
      );
    },
  },
  {
    ...
    content: () => {
      return (
        <p>
          Use Squads smart accounts to build a secure and reliable app for
          splitting payments between friends. In this course, you'll learn the
          basics of working with the Squads SDK, expand on your Web3.js
          knowledge, and effectively implement the SPL Token SDK to create a
