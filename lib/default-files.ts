...
export const DEFAULT_FILES: Record<string, EditorDocument> = {
  ...
  "/node/src/assets/logo.svg": {
    filePath: "/node/src/assets/logo.svg",
    loading: false,
    value: stripIndent(`
...
export const ANCHOR_FILES: Record<string, EditorDocument> = {
  "/anchor/programs/zircon/src/lib.rs": {
    filePath: "/anchor/programs/zircon/src/lib.rs",
    loading: false,
    value: stripIndent(`
  ...
  "/anchor/programs/zircon/Cargo.toml": {
    filePath: "/anchor/programs/zircon/Cargo.toml",
    loading: false,
    value: stripIndent(`
    [package]
    name = "zircon"
  ...
  "/anchor/programs/zircon/Xargo.toml": {
    filePath: "/anchor/programs/zircon/Xargo.toml",
    loading: false,
    value: stripIndent(`
  ...
  "/anchor/tests/index.ts": {
    filePath: "/anchor/tests/index.ts",
    loading: false,
    value: stripIndent(`
    import * as anchor from "@coral-xyz/anchor";
    import { Program } from "@coral-xyz/anchor";
    import { Zircon } from "../target/types/program";
    
    describe("program", () => {
      // Configure the client to use the local cluster.
      anchor.setProvider(anchor.AnchorProvider.env());
    
      const program = anchor.workspace.Zircon as Program<Zircon>;
...
export const REACT_FILES: Record<string, EditorDocument> = {
  "/react/src/App.css": {
    filePath: "/react/src/App.css",
    loading: false,
    value: stripIndent(`
    #root {
      max-width: 1280px;
  ...
  "/react/src/App.tsx": {
    ...
    loading: false,
    value: stripIndent(`import { useState } from "react";
...
export default App;
  ...
  "/react/src/vite-env.d.ts": {
    filePath: "/react/src/vite-env.d.ts",
    loading: false,
    value: stripIndent(`
  ...
  "/react/src/main.tsx": {
    ...
    loading: false,
    value: stripIndent(`import React from "react";
...
ReactDOM.createRoot(document.getElementById("root")!).render(
  ...
  "/react/public/vite.svg": {
    filePath: "/react/public/vite.svg",
    loading: false,
    value: stripIndent(`
  ...
  "/react/src/assets/react.svg": {
    filePath: "/react/src/assets/react.svg",
    loading: false,
    value: stripIndent(`
  ...
  "/react/tsconfig.node.json": {
    filePath: "/react/tsconfig.node.json",
    loading: false,
    value: stripIndent(`
    {
      "compilerOptions": {
...
export const ALL_FILES: Record<string, EditorDocument> = {
  ...DEFAULT_FILES,
  ...REACT_FILES,
  ...ANCHOR_FILES
};
